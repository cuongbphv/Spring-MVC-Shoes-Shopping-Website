...
<body>
	...
	<div class="col-sm-12" style="text-align: center">
		<input id="pageDeliveryHistoryNums" type="hidden" value="${pageNums }" />
		<c:if test="${pageNums > 1 }">
			<ul class="pagination pagination">
				<li class="prevDeliveryHistory"><a>&#10096;&#10096;</a></li>
				<c:forEach begin="0" end="${pageNums - 1}" varStatus="loop">
					<li class="pageDeliveryHistoryItem ${loop.index+1 == page?'active':'' } "><a>${loop.index + 1}</a></li>
				</c:forEach>
				<li class="nextDeliveryHistory"><a>&#10097;&#10097;</a></li>
			</ul>
		</c:if>
