...
<head>
  ...
  <link rel="stylesheet" href="<c:url value="/resources/myweb/css/cart.css" />">
  ...
  <script src="<c:url value="/resources/myweb/js/cart.js" />" type="text/javascript" charset="utf-8"></script>
  ...
  <title>Giỏ hàng</title>
	...
	<body onload="LoadPage()" onresize="Resize()" style="background-image: url('<c:url value="/resources/myweb/img/background.jpg" />')">
		...
		<div id="cartWrapper" class="cartWrap container">
