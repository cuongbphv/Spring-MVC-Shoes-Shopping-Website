...
<title>GREATS - Danh mục sản phẩm</title>
</head>
	...
	<div id="giay" class="row saleWrap container-fluid">
		...
		<div class="slidebar col-md-2 container-fluid" style="overflow-y:scroll; height: 500px;">
			<p style="padding-left: 25px; padding-top: 15px; font-size: 14px;">DANH
				MỤC SẢN PHẨM</p>
			<a class="slideItem col-md-12" style="text-transform: uppercase;"
			...
			<c:forEach var="productList" items="${list }">
				...
				<div class="product col-md-10 col-md-offset-2">
					<div class="col-md-12 col-xs-12">
						<a href="/VerOne/shopping/type/${productList[0].productType.iD }">
							<h3 style="text-transform: uppercase;" class="typeHeader">
								${productList[0].productType.name }</h3>
						</a>
					</div>
											...
											<c:choose>
												<c:when test="${product.discount > 0}">
													<span style="text-decoration: line-through;"><fmt:formatNumber
															...
															currencySymbol="" minFractionDigits="0" /></span>
													<br />
				...
				<div class="line col-md-6 col-md-offset-4 col-xs-6 col-xs-offset-3"></div>
